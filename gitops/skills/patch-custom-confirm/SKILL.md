---
name: gitops:patch-custom-confirm
...
# /gitops:patch-custom-confirm

Execute a previously approved custom patch.

**MCP tool:** `mcp__gitops__patch_custom_confirm`

## What To Do

1. Call `mcp__gitops__patch_custom_confirm(execution_id)`.
