---
name: gitops:secret-custom-confirm
...
# /gitops:secret-custom-confirm

Execute a previously approved custom sealed-secret creation.

**MCP tool:** `mcp__gitops__secret_custom_confirm`

## What To Do

1. Call `mcp__gitops__secret_custom_confirm(execution_id)`.
