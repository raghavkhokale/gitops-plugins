---
name: p1as:secret-cert-host-confirm
...
# /p1as:secret-cert-host-confirm

Execute a previously approved TLS sealed-secret creation.

**MCP tool:** `mcp__server__secret_cert_host_confirm`

## What To Do

1. Call `mcp__server__secret_cert_host_confirm(execution_id)`.
